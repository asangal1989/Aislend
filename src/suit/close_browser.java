...
public class close_browser extends global_variables{
	...
	@Test	
	  public void CloseBrowser() {
		...
		try
		{
			...
			test_data=getExcelSheet.readInputs(path_lib_testcase+prop.getProperty("aislend_CloseBrowser_FileName"), prop.getProperty("aislend_CloseBrowser_SheetName"));
			...
			for(List TestData:test_data)
			  {
				  ...
				  output.writeResult(UseCase_ID,TestCase_ID,path_lib_testcase+prop.getProperty("aislend_CloseBrowser_FileName"), prop.getProperty("aislend_CloseBrowser_SheetName"),result_log,test_data.indexOf(TestData),Description,Expected_result,this.getClass().getName());				  
