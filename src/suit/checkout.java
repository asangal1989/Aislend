...
public class checkout extends global_variables{
			...
			for(List TestData:test_data)
			  {
				  ...
				  if(UseCase_ID.contains("US_ID_01") && TestCase_ID.contains("TC_CityMarket_38"))
				  {
 					  System.out.println("");
				  }
				  ...
				  output.writeResult(UseCase_ID,TestCase_ID,path_lib_testcase+prop.getProperty("aislend_Checkout_FileName"), prop.getProperty("aislend_Checkout_SheetName"),result_log,test_data.indexOf(TestData),Description,Expected_result,this.getClass().getName());				  
